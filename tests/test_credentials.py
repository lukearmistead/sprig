...
class TestAppendAccessToken:
    ...
    @patch('sprig.credentials.get_credential')
    @patch('sprig.credentials.set_credential')
    def test_append_new_token(self, mock_set_credential, mock_get_credential):
        ...
        result = credentials.append_access_token("token_new456789012345678901234")

        assert result is True
        call_args = mock_set_credential.call_args[0]
        assert call_args[0] == credentials.KEY_ACCESS_TOKENS
    ...
    def test_append_duplicate_token(self, mock_set_credential, mock_get_credential):
        ...
        result = credentials.append_access_token("token_test456789012345678901234")
...
class TestMaskCredential:
    ...
    def test_mask_long_credential(self):
        ...
        result = credentials.mask_credential("app_1234567890abcdefghijk")
